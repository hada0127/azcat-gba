...
#define PLAYER_BASE_SPEED   FP_FROM_FLOAT_CONST(1.4f)    /* 이동속도 상향 */
...
#define CAT_GRAVITY         FP_FROM_FLOAT_CONST(0.025f)  /* 낙하 중력 소폭 증가 */
#define CAT_BASE_FALL       FP_FROM_FLOAT_CONST(0.05f)   /* 기본 낙하속도 소폭 증가 */
...
#define CAT_BOMB_RESPAWN_INTERVAL  60  /* 폭탄 후 고양이 재생성 간격 (1초@60fps) */
